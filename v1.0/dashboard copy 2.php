...
<!-- Reactivation Request Modal - Place this after the quick actions section -->
...
function openContactSupport() {
    // Open the feedback modal instead of reactivation modal
    ...
    if (messageBubble && feedbackModal) {
        ...
        // Pre-fill the subject and message for reactivation request
        setTimeout(() => {
            ...
            if (subjectField && !subjectField.value) {
                subjectField.value = '🔴 ACCOUNT REACTIVATION REQUEST - URGENT';
                subjectField.style.borderColor = 'var(--accent)';
                subjectField.style.backgroundColor = 'var(--accent-bg)';
            }
            
            if (messageField) {
                const prefillMessage = `Dear Asha Bank Support Team,

My account has been deactivated. I would like to request reactivation of my account.
...
I assure you that I will comply with all bank policies and regulations. Please review my request and reactivate my account at your earliest convenience.

Thank you for your understanding.`;
                
                messageField.value = prefillMessage;
                if (charCountSpan) charCountSpan.textContent = messageField.value.length;
                messageField.style.borderColor = 'var(--accent)';
                messageField.style.backgroundColor = 'var(--accent-bg)';
            }
        }, 400);
    } else {
        // Fallback alert if modal not found
        alert('Please contact customer support at support@ashabank.bd or call 16479 to request account reactivation.');
    }
}


// Also update the close function
function closeReactivationModal() {
    const modal = document.getElementById('reactivationModal');
    if (modal) {
        ...
        <div class="quick-actions">
            ...
            <?php else: ?>
                <div class="action-btn disabled">
                    ...
                    <span>Account Deactivated By Admin</span>
                </div>
                <button class="action-btn contact-support" onclick="openContactSupport()">
                    <i class="fas fa-headset"></i> 
                    <span>Request Reactivation via Message</span>
                </button>
